...
const Hooks = () => {
  ...
  const onLeave = (origin, destination, direction) => {
    ...
    if (!origin.isFirst && direction === "up") {
      ...
      bgOrigin.style.transform =
        "translateX(0px) translateY(" + translateY.toFixed(0) + "px)";
    }
  };
  ...
  const onSendAttend = (e) => {
    ...
    axios
      .post("https://domialapi.waproks.de/savereg", formData)
      .then((res) => {
  ...
  return (
    <div className="App">
      <Head>
        <title>Anna-Lena & Dominik - Unsere Hochzeitseinladung</title>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Allison&family=Poppins&display=swap"
          rel="stylesheet"
        />
      </Head>
      <ReactFullpage
        licenseKey="gplv3-license"
        navigationTooltips={["Wir heiraten!", "Unser Tag", "Infos", "Anmeldung"]}
        navigation
        navi
              ...
              <ul>
                ...
                <li>
                  <img
                    ...
                    src="/static/images/wedding-rings.png"
                  />{" "}
                  <span style={{ verticalAlign: "middle" }}>Trauung</span>
                </li>
                <li>
                  <img
                    className="tt-icon"
                    style={{ verticalAlign: "middle" }}
                    src="/static/images/champagne-glass.png"
                  />{" "}
                ...
                <li>
                  ...
                  />{" "}
                  <span style={{ verticalAlign: "middle" }}>Fotos</span>
                </li>
              </ul>
              <ul>
                <li>17:00 Uhr</li>
            ...
            <div key="section3" id="section3" className="section">
              ...
              <Row className="justify-content-xs-center">
                <Col style={{ textAlign: "right" }}>
                  <p>
                    <strong>Trauung</strong>
                  </p>
                </Col>
                <Col style={{ textAlign: "left" }}>
                  <p>Klosterkirche Mariä Krönung</p>
                  <p>79254 Oberried</p>
                </Col>
              </Row>
              <Row className="justify-content-xs-center">
                <Col style={{ textAlign: "right" }}>
                  <p>
                    <strong>Location (inkl. Sektempfang)</strong>
                  </p>
                </Col>
                <Col style={{ textAlign: "left" }}>
              ...
              <Row className="justify-content-xs-center">
                <Col style={{ textAlign: "right" }}>
                  <p>
                    <strong>Tipps für Geschenksuchende</strong>
                  </p>
                </Col>
                <Col style={{ textAlign: "left" }}>
              ...
              <Row className="justify-content-xs-center">
                <Col sm="12" md={{ size: 6, offset: 3 }}>
                  <Form onSubmit={onSendAttend}>
                    ...
                    <Button color="light" size="lg" style={{ width: "100%" }}>
                      Abschicken &raquo;
                    </Button>
                    {alert.visible && (
